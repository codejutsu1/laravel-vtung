...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-vtung.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-vtung)
...
```bash
php artisan vendor:publish --tag="laravel-vtung-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="laravel-vtung-views"
```
...
- [Daniel Dunu](https://github.com/Daniel Dunu)
